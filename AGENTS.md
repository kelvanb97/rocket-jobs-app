...
- Shared Rocket Jobs skills live in `.skills/`
- `.agents/skills/` and `.claude/skills/` should point at `.skills/`
- Claude compatibility files remain in `.mcp.json`, `.claude/settings.json`, and `CLAUDE.md`
